...
\begin{longtable}{@{}%
  P{0.10\linewidth} % Attack / Targeted structure (Post-IBPB?)
  P{0.10\linewidth} % Attacker model / boundary
  P{0.08\linewidth} % Target processor
...
Intel (Haswell, Skylake, Xeon), any that uses an RSB&
RSB underflow/overfill; entry without RSB sanitization; early \texttt{ret} reachable &
