...
\begin{center}
\begin{tabular}{|m{5mm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|}
  \hline
  Paper & Attack & Attacker model & Preconditions & Mitigations & Reproducibility & Side-channel used & CC impact \\ 
  \hline
  11 & Spectre-BCB & & & bounds-check hardening, masking, LFENCE/Speculation Barriers & & & \\ 
  \hline
  11 & Spectre-BTI & & & IBRS, IBPB, Retpoline & & & \\ 
  \hline
\end{tabular}
\end{center}
